...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const handleStreakAndBadges = async (userToUpdate: UserProfile): Promise<UserProfile> => {
      ...
      // Determine if it's a new calendar day since last login
      const isNewDay = today.getFullYear() > lastLoginDate.getFullYear() ||
      ...
      if (isNewDay) {
        ...
        // Days since last login based on activity array. If no activity, assume 7+ days.
        ...
        // Shift activity for all days missed
