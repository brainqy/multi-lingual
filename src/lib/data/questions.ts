...
export let sampleInterviewQuestions: InterviewQuestion[] = [
  ...
  },
  {
    ...
    tags: ['javascript', 'string manipulation', 'algorithms', 'react'],
    difficulty: 'Easy',
    rating: 3.7,
    ratingsCount: 28,
    userComments: [],
  ...
  },
  {
    id: 'aws1',
    category: 'Technical',
    questionText: "What is the primary difference between Amazon S3 and EBS?",
    baseScore: 10,
    isMCQ: true,
    mcqOptions: [
        "S3 is object storage, while EBS is block storage for EC2 instances.",
        "EBS is a database service, while S3 is for caching.",
        "S3 is for hosting websites, EBS is for running servers.",
        "There is no major difference; they are interchangeable."
    ],
    correctAnswer: "S3 is object storage, while EBS is block storage for EC2 instances.",
    answerOrTip: "S3 (Simple Storage Service) is a scalable object storage service for data backup, archiving, and analytics. EBS (Elastic Block Store) provides persistent block-level storage volumes for use with EC2 instances, much like a hard drive.",
    tags: ['aws', 'cloud'],
    difficulty: 'Medium',
    rating: 4.4,
    ratingsCount: 8,
  ...
  },
  {
    id: 'python1',
    category: 'Coding',
    questionText: "What will be the output of `print(type([]))` in Python?",
    baseScore: 5,
    isMCQ: true,
    mcqOptions: [
        "<class 'array'>",
    ...
    answerOrTip: "In Python, `[]` creates an empty list. The `type()` function returns the type of an object, which in this case is `<class 'list'>`.",
    tags: ['python', 'coding'],
    difficulty: 'Easy',
    rating: 4.1,
    ratingsCount: 15,
  ...
  },
  {
    id: 'angular1',
    category: 'Technical',
    questionText: "What is the main purpose of a 'Service' in Angular?",
    baseScore: 10,
    isMCQ: true,
    mcqOptions: [
        "To handle the user interface and display data.",
        "To manage routing between different components.",
        "To share data or logic across multiple components.",
        "To define the HTML structure of a component."
    ],
    correctAnswer: "To share data or logic across multiple components.",
    answerOrTip: "Services in Angular are singleton objects that get instantiated only once during the lifetime of an application. They are used for purposes like fetching data, logging, or any other business logic that needs to be shared across components.",
