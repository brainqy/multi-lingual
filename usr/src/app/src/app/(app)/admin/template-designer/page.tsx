            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
               ...
               <div>
                ...
                <Controller name="bodyColor" control={control} render={({ field }) => <Input id="template-bodyColor" type="color" {...field} />} />
              </div>
               <div>
              ...
              <div>
                <Label htmlFor="template-textAlign">Text Alignment</Label>
